...
{#if isDeepDiveOpen}
  <div class="fixed top-0 z-[9995] h-svh w-full overflow-x-scroll [inset-inline-start:0]" transition:fly={{ duration: 1000, easing: cubicInOut, x: '110dvw' }} on:introend={() => dispatch('introend')}>
    <div
