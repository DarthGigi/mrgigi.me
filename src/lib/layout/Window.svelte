...
<div class={`group max-w-3xl p-4 md:p-0 ${$$props.class}`}>
  <div style={`box-shadow: 0 0 0 1px rgb(255 255 255 / 30%),0 0 0 1.5px rgba(0,0,0,.8),0 2.8px 2.2px rgba(0,0,0,.034),0 6.7px 5.3px rgba(0,0,0,.048),0 12.5px 10px rgba(0,0,0,.06),0 22.3px 17.9px rgba(0,0,0,.072),0 41.8px 33.4px rgba(0,0,0,.086),0 100px 80px rgba(0,0,0,.12); ${style}`} class="flex min-h-[120px] flex-col items-stretch rounded-xl bg-black/90 pt-3 text-white transition-all duration-300 ease-linear md:bg-black/75">
